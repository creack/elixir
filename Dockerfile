...
RUN             apt-get update && apt-get install -y elixir git erlang-xmerl erlang-crypto erlang-syntax-tools erlang-inets erlang-ssl erlang-public-key erlang-asn1 erlang-dev
